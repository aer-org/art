...
function buildVolumeMounts(group, isMain) {
    ...
    if (fs.existsSync(agentRunnerSrc)) {
        ...
        const hasFiles = fs.existsSync(groupAgentRunnerDir) &&
...
export async function spawnSubAgentContainer(opts) {
    ...
    try {
        await runContainerAgent(virtualGroup, {
            prompt: opts.prompt,
        ...
        logger.error({ agentId: opts.agentId, name: opts.name, err }, 'Sub-agent container failed');
    }
}
