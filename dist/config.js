...
export const SENDER_ALLOWLIST_PATH = path.join(HOME_DIR, '.config', 'aer-art', 'sender-allowlist.json');
...
export const CONTAINER_IMAGE = process.env.CONTAINER_IMAGE || 'ghcr.io/jellyheadandrew/aer-art-agent:latest';
