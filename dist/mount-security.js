/**
 * Mount Security Module for AerArt
 *
 * Validates additional mounts against an allowlist stored OUTSIDE the project root.
 * This prevents container agents from modifying security configuration.
 *
 * Allowlist location: ~/.config/aer-art/mount-allowlist.json
 */
import fs from 'fs';
import os from 'os';
...
export function loadMountAllowlist() {
    ...
    try {
        ...
        // Normalize string entries to AllowedRoot objects
        // Supports both "/path/to/dir" and { path: "/path/to/dir", allowReadWrite: true }
