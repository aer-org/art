...
export async function run(targetDir) {
    ...
    const { ART_DIR_NAME, CONTAINER_IMAGE, setEngineRoot, setCredentialProxyPort, } = await import('../config.js');
    const { initRuntime, getRuntimeBin } = await import('../container-runtime.js');
    ...
    setCredentialProxyPort(parseInt(process.env.CREDENTIAL_PROXY_PORT || '3002', 10));
