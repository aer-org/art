...
import { ART_DIR_NAME, setEngineRoot, setDataDir, getProjectRoot, getCredentialProxyPort, setCredentialProxyPort, } from './config.js';
...
describe('config', () => {
    ...
    describe('setEngineRoot / getProjectRoot', () => {
        ...
        it('updates project root and derived paths', async () => {
            ...
            expect(config.GROUPS_DIR).toBe(path.resolve('/tmp/test-engine', 'groups'));
