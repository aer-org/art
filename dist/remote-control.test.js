...
describe('remote-control', () => {
    ...
    describe('startRemoteControl', () => {
        it('spawns claude remote-control and returns the URL', async () => {
            ...
            expect(spawnMock).toHaveBeenCalledWith('claude', ['remote-control', '--name', 'AerArt Remote'], expect.objectContaining({ cwd: '/project', detached: true }));
