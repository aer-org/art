...
- **Status reports are worthless.** Your plan must be actionable.`;

export const plan: StageTemplate = {
  name: 'plan',
  type: 'agent',
  description:
    'Planning stage. Reads vision and insights, writes PLAN.md and METRICS.md.',
  prompt:
    SOUL +
