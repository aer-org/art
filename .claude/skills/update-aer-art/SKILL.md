---
name: update-aer-art
description: Efficiently bring upstream AerArt updates into a customized install, with preview, selective cherry-pick, and low token usage.
---

# About

Your AerArt fork drifts from upstream as you customize it. This skill pulls upstream changes into your install without losing your modifications.

Run `/update-aer-art` in Claude Code.
...
# Goal
Help a user with a customized AerArt install safely incorporate upstream changes without a fresh reinstall and without blowing tokens.
