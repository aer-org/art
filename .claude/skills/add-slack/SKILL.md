...
This skill adds Slack support to AerArt, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/aer-art-slack.git
```
...
>
> The JID format for AerArt is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.aer-art`
