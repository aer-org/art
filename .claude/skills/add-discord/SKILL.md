---
name: add-discord
description: Add Discord bot channel integration to AerArt.
---

# Add Discord Channel

This skill adds Discord support to AerArt, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/aer-art-discord.git
```
...
4. Service is running: `launchctl list | grep aer-art`
...
- @mention translation (Discord `<@botId>` → AerArt trigger format)
